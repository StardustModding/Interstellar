...
object InterstellarRegistries {
    ...
    val PLANETS_KEY = RegistryKey.ofRegistry<Planet>(Interstellar.id("planets"))
    val STAR_SYSTEMS_KEY = RegistryKey.ofRegistry<StarSystem>(Interstellar.id("star_systems"))
    val GASES_KEY = RegistryKey.ofRegistry<Gas>(Interstellar.id("gases"))
