...
object InterstellarRegistries {
    ...
    @JvmField
    val PLANET_SETTINGS =
        SimpleDefaultedRegistry(id("planet_settings").toString(), PLANET_SETTINGS_KEY, Lifecycle.experimental(), false)
    ...
    @JvmField
    val STAR_SYSTEMS =
        SimpleDefaultedRegistry(id("star_system").toString(), STAR_SYSTEMS_KEY, Lifecycle.experimental(), false)
